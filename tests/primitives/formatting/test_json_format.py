...
class JSONFormatFormatAsStringTest(unittest.TestCase):
    ...
    def test_multiple_windows_multiple_rows(self):
        X = np.array([
            [[1, 2], [3, 4]],
            [[5, 6], [7, 8]],
        ])
...
class JSONFormatFormatAsIntegerLegacyTest(unittest.TestCase):
    ...
    def test_trunc_none_single_sample(self):
    ...
    def test_trunc_none_multiple_samples(self):
    ...
    def test_trunc_int_single_window(self):
    ...
    def test_trunc_int_multiple_windows(self):
        X = np.array([
            ["d0:1,d0:2,d0:3"],
            ["d0:4,d0:5,d0:6"],
        ])
