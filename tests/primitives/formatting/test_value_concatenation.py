...
class ValueConcatenationFormatAsStringTest(unittest.TestCase):
    ...
    def test_single_window_multiple_rows_multiple_dims_to_string(self):
        X = np.array([[[1, 2], [3, 4]]])
        out = self.formatter.format_as_string(X)
...
class ValueConcatenationFormatAsIntegerTest(unittest.TestCase):
    ...
    def test_multiple_entries_equal_length_to_integer(self):
    ...
    def test_multiple_entries_unequal_length_to_integer(self):
        X = [['1,2,3', '4,5'], ['6', '7,8']]
        out = self.formatter.format_as_integer(X)
    ...
    def test_multiple_dimensions_to_integer(self):
        X = [['10,20,30,40']]
